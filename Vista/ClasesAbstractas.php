...
<?php
include "../Lecciones/ClasesObjetos/ClaseAbstracta.php";
...
<?php
include "../Lecciones/ClasesObjetos/Objetos/ObjetoClaseAbstracta.php";
include "../Lecciones/ClasesObjetos/Objetos/ObjetoClaseAbstractaCondicional.php";
include "../Lecciones/ClasesObjetos/Objetos/ObjetoClaseAbstractaParametrosAdd.php";
